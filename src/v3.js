export const v3 = {
    "productName": "Micro-Site Launchpad",
    "productTier": "release",
    ...
    "capabilities": [
        "Domain-specific workbench: One-Week Website Launchpad",
        "Operational table: Site content pack",
    ...
    "releaseChecklist": [
        ...
        "Content Completeness is documented with evidence",
        "Accessibility Basics has no unresolved blocker",
        "Static content pack verified",
        "Sitemap verified",
        "Owner handoff checklist verified"
    ],
    "operations": [
